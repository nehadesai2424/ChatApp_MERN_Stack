...
const Sidebar = () => {
  ...
  return (
    <div className={`bg-[#8185B2]/10 h-full p-5 ronded-xl overflow-y-scroll text-white  ${selectedUser ? "max-md-hidden" : ''}`}>
      <div className='pb-5'>
        <div className='flex  justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            bg-[#22142b] border border-gray-600 text-gray-100 hidden group-hover:block'>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          <div onClick={() => { setSelectedUser(user) ; setUnseenMessages((prev) =>
             ({ ...prev, [user._id]: 0 })) }}
            key={index} className={`relative flex items-center gap-2 p-3 pl-4 rounded 
